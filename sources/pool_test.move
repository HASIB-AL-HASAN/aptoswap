...
module Aptoswap::pool_test {
    ...
    #[test(admin = @Aptoswap)] 
    fun test_amm_simulate_1000(admin: signer) {
        test_amm_simulate_1000_impl(&admin);
    }

    #[test(admin = @Aptoswap)] 
    fun test_amm_simulate_3000(admin: signer) {
        test_amm_simulate_3000_impl(&admin);
    }

    #[test(admin = @Aptoswap)] 
    fun test_amm_simulate_5000(admin: signer) {
        test_amm_simulate_5000_impl(&admin);
    }

    #[test(admin = @Aptoswap)] 
    fun test_amm_simulate_10000(admin: signer) {
    ...
    #[test_only]
    fun test_utils_create_pool(admin: &signer, init_x_amt: u64, init_y_amt: u64): address {
        let admin_addr = signer::address_of(admin);
    ...
    fun test_utils_amm_simulate(admin: &signer, s: &AmmSimulationData) {
        let admin_addr = signer::address_of(admin);
        account::create_account_for_test(admin_addr);
    ...
    #[test_only]
    fun test_amm_simulate_1000_impl(admin: &signer) {
    ...
    #[test_only]
    fun test_amm_simulate_3000_impl(admin: &signer) {
        let s = AmmSimulationData {
            x_init: 100000,
            y_init: 1481000000,
            data: vector [
    ...
    #[test_only]
    fun test_amm_simulate_5000_impl(admin: &signer) {
        let s = AmmSimulationData {
            x_init: 100000,
            y_init: 3948200000,
            data: vector [
    ...
    #[test_only]
    fun test_amm_simulate_10000_impl(admin: &signer) {
        let s = AmmSimulationData {
            x_init: 100000,
            y_init: 1048100000,
            data: vector [
